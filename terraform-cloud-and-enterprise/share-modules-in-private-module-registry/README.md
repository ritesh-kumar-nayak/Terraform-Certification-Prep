...
- Follow Naming Conventions for modules
  ...
  - **Sample:** terraform_aws_s3_static_website_module
- **Repository Name:** terraform_aws_s3_static_website_module
...
- **Tag Version:** 1.0.0
- **Release Title:** Release-1 terraform_aws_s3_static_website_module
- **Write:** Terraform Module for Private Registry - terraform_aws_s3_static_website_module
